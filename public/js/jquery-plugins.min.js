 ...
 */
(function(a){a.fn.fontResize=function(c){var b=a.extend({},a.fn.fontResize.defaults,c);this.each(function(){a(this).append(b.defaultLabels);a.cookie(b.defaultCookieName)&&a.fn.fontResize.reSize(false,a.cookie(b.defaultCookieName));a("."+b.defaultIncreaseClass).click(function(){a.fn.fontResize.reSize(true);return false});a("."+b.defaultDecreaseClass).click(function(){a.fn.fontResize.reSize(false);return false});a("."+b.defaultNormalizeClass).click(function(){a.fn.fontResize.reSize(false,b.defaultSize);
return false})})};a.fn.fontResize.reSize=function(c,b){if(b){a(a.fn.fontResize.defaults.defaultTargetNode).css("font-size",b);b==a.fn.fontResize.defaults.defaultSize&&a.cookie(a.fn.fontResize.defaults.defaultCookieName,null,a.fn.fontResize.defaults.defaultcookieParms)}else{c=c?1+a.fn.fontResize.defaults.defaultChangePercent/100:1-a.fn.fontResize.defaults.defaultChangePercent/100;b=a(a.fn.fontResize.defaults.defaultTargetNode).css("font-size");var d=parseInt(b);if(!isNaN(d)){d=b.replace(d,"");c=Math.round(parseInt(b)*
c)+d;a(a.fn.fontResize.defaults.defaultTargetNode).css("font-size",c);return a.cookie(a.fn.fontResize.defaults.defaultCookieName,c,a.fn.fontResize.defaults.defaultcookieParms)}}}})(jQuery);
jQuery.fn.fontResize.defaults={defaultTargetNode:"body",defaultChangePercent:5,defaultSize:"11px",defaultLabels:'<a href="" class="decreaseFont fontresize">A-</a><a href="" class="normalizeFont fontresize">A</a><a href="" class="increaseFont fontresize">A+</a>',defaultDecreaseClass:"decreaseFont",defaultIncreaseClass:"increaseFont",defaultNormalizeClass:"normalizeFont",defaultInsertionNode:"fontResizer",defaultCookieName:"fontResizer",defaultcookieParms:{expires:14,path:"/"}};
