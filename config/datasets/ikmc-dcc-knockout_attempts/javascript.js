...
jQuery(document).ready(function() {
  jQuery(".ikmc-dcc-knockout_attempts_allele_progress_clones_toggle").live("click", function () {
    jQuery(this).parent().parent().find(".ikmc-dcc-knockout_attempts_allele_progress_clones_content").slideToggle("fast");
  ...
  jQuery(".ikmc-dcc-knockout_attempts_allele_progress_clones_toggle").each( function (index) {
    jQuery(this).parent().parent().find(".ikmc-dcc-knockout_attempts_allele_progress_clones_content").hide();
